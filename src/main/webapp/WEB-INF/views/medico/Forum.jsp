		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="jumbotron" style="padding-top: 1px; background-color: white">
                   <button type="button" href="#" class="btn btn-success" data-toggle="modal" data-target="#modalcadformed">Criar novo Post no forum</button>
                    <br><br>
                    ...
                    <c:forEach var="postsForum" items="${postsForum}">
                        <div class="thumbnail" style=" background-color: #e0e0e0; border-color: black">
                            ...
                            <p align="right"><b>Autor: ${postsForum.nome }</b></p>
